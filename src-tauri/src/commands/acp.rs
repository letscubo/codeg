...
"#;
  ...
  "permissions": { "allow": ["Shell(ls)"], "deny": [] }
    ...
    fn the_latest_spec_still_names_the_package_downstream_readers_key_off() {
        let (latest, pinned) = npm_install_attempts("hermes-agent@0.21.2", None, true).unwrap();
...
"#
    ...
    fn npm_bootstrap_failure_names_the_proxy_only_for_a_wrapper_download() {
        ...
        let annotated = annotate_npm_bootstrap_failure("hermes-agent@0.21.2", download());
