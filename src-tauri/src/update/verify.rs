...
const TAURI_PUBKEY_B64: &str = "dW50cnVzdGVkIGNvbW1lbnQ6IG1pbmlzaWduIHB1YmxpYyBrZXk6IDhBMDNERDExMzIwQjE2OApSV1Jvc1NBVDBUMmdDSHdqaWxTcERlQW9ZYkljaCtsT1JXMkZxR1BzaWdoWHdiaGhtWXhvYWthVgo=";
...
mod tests {
    ...
    fn bare_key_line_parses() {
        let text = "untrusted comment: minisign public key: 8A03DD11320B168\n\
                    RWRosSAT0T2gCHwjilSpDeAoYbIch+lORW2FqGPsighXwbhhmYxoakaV\n";
